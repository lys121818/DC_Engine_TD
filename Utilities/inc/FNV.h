...
namespace YS_Util
{
	...
	inline uint_32 Fnv_1a(unsigned char singleByte, uint_32 hash = s_kSeed)
	{
		return (singleByte ^ hash) * s_kPrime;
	}

	// Hashing Double Bytes (16 bit)
	inline uint_32 Fnv_1a(const unsigned short* doubleBytes, uint_32 hash = s_kSeed)
	{
	...
	inline uint_32 Fnv_1a(const uint_32* fourBytes, uint_32 hash = s_kSeed)
	{
	...
	// Hashing Four Bytes (32 bit)
	inline uint_32 Fnv_1a(const unsigned long* fourBytes, uint_32 hash = s_kSeed)
	{
		const unsigned char* ptr = (const unsigned char*)fourBytes;
	...
	inline uint_32 Fnv_1a(const void* multiBytes, uint_32 hash = s_kSeed)
	{
	...
	// Hashing Four Bytes (32 bit)
	inline uint_32 Fnv_1a(float* floatValue, uint_32 hash = s_kSeed)
	{
	...
	inline uint_32 Fnv_1a(double* doubleValue, uint_32 hash = s_kSeed)
	{
	...
	/// Hashing a string
	inline uint32_t Fnv_1a(const char* text, uint32_t hash = s_kSeed)
	{
